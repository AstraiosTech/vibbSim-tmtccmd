...
#  mount the vibb_sim directory in scratch for editing.  Use VSCode and pallet to select DEV containers: Open folder..
    docker run -it --network=my-net --mount type=bind,src=/Users/michaelbrooks/Desktop/Astraios/Dockerfiles/vibb_simulator,dst=/scratch/ -e DISPLAY=host.docker.internal:0 vibb-sim 
